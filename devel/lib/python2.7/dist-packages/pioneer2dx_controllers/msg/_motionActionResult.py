...
"""autogenerated by genpy from pioneer2dx_controllers/motionActionResult.msg. Do not edit."""
import sys
...
class motionActionResult(genpy.Message):
  ...
  _type = "pioneer2dx_controllers/motionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pioneer2dx_controllers/motionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pioneer2dx_controllers.msg.motionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pioneer2dx_controllers.msg.motionResult()
