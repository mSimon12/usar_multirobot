...
(cl:in-package quadrotor_controllers-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <motion-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motion-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quadrotor_controllers-srv:<motion-request> is deprecated: use quadrotor_controllers-srv:motion-request instead.")))

(cl:ensure-generic-function 'destination-val :lambda-list '(m))
(cl:defmethod destination-val ((m <motion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_controllers-srv:destination-val is deprecated.  Use quadrotor_controllers-srv:destination instead.")
  (destination m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<motion-request>)))
  ...
  "quadrotor_controllers/motionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'motion-request)))
  "Returns string type for a service object of type 'motion-request"
  "quadrotor_controllers/motionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <motion-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motion-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quadrotor_controllers-srv:<motion-response> is deprecated: use quadrotor_controllers-srv:motion-response instead.")))

(cl:ensure-generic-function 'succeeded-val :lambda-list '(m))
(cl:defmethod succeeded-val ((m <motion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_controllers-srv:succeeded-val is deprecated.  Use quadrotor_controllers-srv:succeeded instead.")
  (succeeded m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<motion-response>)))
  ...
  "quadrotor_controllers/motionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'motion-response)))
  "Returns string type for a service object of type 'motion-response"
  "quadrotor_controllers/motionResponse")
