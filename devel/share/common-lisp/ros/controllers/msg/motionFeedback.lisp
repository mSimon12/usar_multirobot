...
(cl:defmethod cl:initialize-instance :after ((m <motionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controllers-msg:<motionFeedback> is deprecated: use controllers-msg:motionFeedback instead.")))

(cl:ensure-generic-function 'actual_position-val :lambda-list '(m))
(cl:defmethod actual_position-val ((m <motionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controllers-msg:actual_position-val is deprecated.  Use controllers-msg:actual_position instead.")
  (actual_position m))
