...
(cl:defmethod cl:initialize-instance :after ((m <motion-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motion-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controllers-srv:<motion-request> is deprecated: use controllers-srv:motion-request instead.")))

(cl:ensure-generic-function 'destination-val :lambda-list '(m))
(cl:defmethod destination-val ((m <motion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controllers-srv:destination-val is deprecated.  Use controllers-srv:destination instead.")
  (destination m))
...
(cl:defmethod cl:initialize-instance :after ((m <motion-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motion-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controllers-srv:<motion-response> is deprecated: use controllers-srv:motion-response instead.")))

(cl:ensure-generic-function 'succeeded-val :lambda-list '(m))
(cl:defmethod succeeded-val ((m <motion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controllers-srv:succeeded-val is deprecated.  Use controllers-srv:succeeded instead.")
  (succeeded m))
