    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if (event == 'robot_to_call') or self.update_robot_info:
                ...
                add_layout = [
                    [sg.Text('Mission ID:', size = (17,1)), sg.Input(key='m_id',size = (13,1))],
                    [sg.Text('Mission PRIORITY:', size = (17,1)), sg.Input(key='m_p',size = (13,1))],
                    [sg.OK(), sg.Cancel()]
                ]
                add_window = sg.Window('NEW MISSION', layout = add_layout, size = (300,100))
            ...
            if selected_mission not in self.sended_missions:
                ...
                if event == 'add_task':
                    ...
                    add_window = sg.Window('NEW TASK', layout = add_t_layout, size = (250,330), finalize=True)
