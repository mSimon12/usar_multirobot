...
echo_and_run cd "/media/marcelo/ARQUIVOS/desenvolvimento/projetos/usar_multirobot/src/pioneer3at_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/media/marcelo/ARQUIVOS/desenvolvimento/projetos/usar_multirobot/build/pioneer3at_ros" \
    install \
    --root="${DESTDIR-/}" \
