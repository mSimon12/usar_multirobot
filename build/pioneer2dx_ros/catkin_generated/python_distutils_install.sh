...
echo_and_run cd "/media/marcelo/ARQUIVOS/desenvolvimento/projetos/usar_multirobot/src/pioneer2dx_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/media/marcelo/ARQUIVOS/desenvolvimento/projetos/usar_multirobot/build/pioneer2dx_ros" \
    install \
    --root="${DESTDIR-/}" \
